...
| S-04 | CIBSE TM52: Operational performance — the limits of acceptability | 2013 | CIBSE | **SECONDARY-PENDING** — as S-02. ALSO the source of the Trm running-mean Eq 2.2/2.3 constants used by TM59:2026 criterion a (flagged inside the pack) | pending author acquisition | `uk_tm52` rule pack (gated); TM59:2026 Trm cross-reference |
