...
Last updated: **2026-08-28** (session 3 — TM59:2017 + TM52 machine-verified; all four packs now source-verified)
...
| 5 — IDF readiness | generic + standards-specific checks, passport | PENDING | verified model-limit rules (ADO §2.6, TM59:2017 §3.3) ready as readiness checks |
...
1. Standards **diff viewer** (TM59:2017 ↔ 2026) is now fully unblocked (both packs
