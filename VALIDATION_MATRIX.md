...
| VAL-CAMP-13 (V13) | independent recomputation | every displayed number recomputed from primary data by fresh code | raw EPW bytes + 01BA SaferHeat eplusout.csv | CIBSE definitions (SHA-pinned packs) | Weather metrics exact; criterion A % exact; adaptive % ±0.1 | verified (weather 5/5, criterion A, comfort) | exact / ±0.1 | PASS | 2026-09-04 | strictest case: fresh TM52 Eq 2.2/2.3 chain + EN 16798-1 written in the campaign, never calling app functions |
| VAL-CAMP-14 (V14/V14b) | boundary flips | TM59:2026 criteria a/b/d + Part O inheritance | synthetic series | CIBSE TM59:2026 + ADO (SHA-pinned) | living 59/60, bedroom 110/111, nights 4/5 (Tn 27), communal 110/111, rounding 0.49/0.50 K; Part O applies 2017 boundaries | all verified | exact | PASS | 2026-09-04 | Cat II; Part O inherits uk_tm59_2017 by design |
| VAL-CAMP-15 (V15) | served-numbers integrity | API payload series ≡ fresh harvest of eplusout.csv (charts plot these arrays verbatim) | archived 01BA SaferHeat run | data/runs + local API | value-for-value equality, all zones | verified (12 zones) | exact | PASS | 2026-09-04 | three-way: E+ file → archive → served payload |

Campaign verdict 2026-09-04: **PASS** — 16 cases: 12 PASS + 2 CONFIRMED_DIRECTIONAL + 2 CONFIRMED, 0 INCOMPLETE, 0 FAIL.
